 ...
 */
    ...
    'reset-irc' => 'Нулиране на IRC ключ',
    'reset-irc-help' => 'Ще трябва да актуализирате всички скриптове или приложения, които използвате, с новия си ключ, след като нулирате IRC ключа.',

 ...
 */
    ...
    'reset-irc' => 'Επαναφορά κλειδιού IRC',
    'reset-irc-help' => 'Θα πρέπει να ενημερώσετε τυχόν σενάρια ή εφαρμογές που χρησιμοποιείτε με το νέο σας κλειδί, μετά την επαναφορά του κλειδιού IRC',
